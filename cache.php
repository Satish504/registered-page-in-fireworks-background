...
<head><script src='https://static.codepen.io/assets/editor/live/console_runner-1df7d3399bdc1f40995a35209755dcfd8c7547da127f6469fd81e5fba982f6af.js'></script>
<script src='https://static.codepen.io/assets/editor/live/css_reload-5619dc0905a68b2e6298901de54f73cefe4e079f65a75406858d92924b4938bf.js'></script><meta charset='UTF-8'><meta name="robots" content="noindex">
<link rel="shortcut icon" type="image/x-icon" href="ico.jpg" />
<link rel="mask-icon" type="" href="https://static.codepen.io/assets/favicon/logo-pin-f2d2b6d2c61838f7e76325261b7195c27224080bc099486ddd6dccb469b8e8e6.svg" color="#111" /><link rel="canonical" href="https://codepen.io/ilpapa/pen/ZqmrEG?page=1&" />
...
$conn = new mysqli("localhost","root", "","stud");
	...
	$query="insert into studentdata(stdname,clgname,rollno,phno,event)values('$name','$clgname','$rollno','$phno','$event')";
...
<form method="post" action="cache.php">
	<div class="close"><button id="close">X</button></div>
		<div class="name" style="color:linear-gradient(red, yellow);">Username</p></div>
		<div class="text"><input type="text" id="name" name="stdname" placeholder="Enter the name"   required></div>
		<br><div class="collegename">Collegename</div>
			<div class="text"><input type="text" id=""  placeholder="Enter the Collegename" name="clgname" required></div>
		<br><div class="collegename">Events:<br>
<select name="abhi">
  <option value="PPT">PPT</option>
  <option value="POSTER">POSTER</option>
  <option value="">CODEit</option>
  <option value="WEB">WEB DESIGN</option>
    <option value="DEBUG">DEBUGGING</option>
  <option value="EXPO">PROJECT EXPO</option>
  <option value="SPOT">SPOT EVENT</option>
     <option value="workshop">WORKSHOP</option>
    <option value="PUBG">PUB G</option>
  
</select>
  
<br><br></div>
	
		<div class="collegename">Rollno</p></div>
		<div class="tex"><input type="text" id="name" name="rollno" placeholder="Enter the Rollno"  required></div>
		<br><div class="phno">Phno</p></div>
		<div class="text"><input type="text" name="phno" id="name" placeholder="Enter the Phone number" onblur="vali(this);" maxlength="10"  required></div><br>
		
<div class="submit"><input type="submit" name="submit" value="Submit" ></div>
		<div class="su"><input type="reset" value="Clear"></div>
		</div>
		</form>
...
function vali(obj) {
		...
		<div class="menu hide">
			<div class="menu__inner-wrap">
				...
				<div class="credits">
					Passionately built by <a href="" target="_blank">Caleb Miller</a>.
				</div>
			</div>
		</div>
	</div>
